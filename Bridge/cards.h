...
public:
    ...
    enum suit_type {spades, hearts, diamonds, clubs, suit_count, no_trump};
    ...
    pip_type pip() { return pip_type(value / suit_count); }
    suit_type suit() { return suit_type(value % suit_count); }
